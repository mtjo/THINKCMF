 ...
 */
package com.base.aframe.http.cache;

import com.base.aframe.core.MemoryLruCache;
import com.base.aframe.utils.CipherUtils;
...
final class HttpMemoryCache implements I_HttpCache {
    ...
    private HttpMemoryCache(WYCacheConfig config, int maxSize) {
    ...
    public static HttpMemoryCache create(int maxSize) {
        return create(new WYCacheConfig(), maxSize);
    }
     ...
     * @return
     */
    public static HttpMemoryCache create(WYCacheConfig config) {
    ...
    public synchronized static HttpMemoryCache create(
            WYCacheConfig config, int maxSize) {
        if (instance == null) {

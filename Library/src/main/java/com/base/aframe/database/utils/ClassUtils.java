...
import com.base.aframe.database.annotate.Table;
import com.base.aframe.core.WYException;
import com.base.aframe.database.ManyToOneLazyLoader;
import com.base.aframe.database.annotate.Id;
            ...
            for (Field f : fs) {
                if (!FieldUtils.isTransient(f) && FieldUtils.isOneToMany(f)) {
                    ...
                    if (type instanceof ParameterizedType) {
                        ...
                        throw new WYException("getOneToManyList Exception:"

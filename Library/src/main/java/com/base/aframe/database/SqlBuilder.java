...
import com.base.aframe.database.utils.Id;
...
import com.base.aframe.database.utils.Property;
...
public class SqlBuilder {
    ...
    public static SqlInfo buildDeleteSql(Object entity) {
        ...
        if (idvalue == null) {
            throw new WYException("getDeleteSQL:" + entity.getClass()
                    + " id value is null");
        }
        StringBuffer strSQL = new StringBuffer(
    ...
    public static SqlInfo buildDeleteSql(Class<?> clazz, Object idValue) {
        ...
        if (null == idValue) {
            throw new WYException("getDeleteSQL:idValue is null");
        }
    ...
    public static SqlInfo getUpdateSqlAsSqlInfo(Object entity) {
        ...
        if (null == idvalue) {// 主键值不能为null，否则不能更新
            throw new WYException("this entity[" + entity.getClass()
                    + "]'s id value is null");
        }
    ...
    public static String getCreatTableSQL(Class<?> clazz) {
        ...
        for (Property property : propertys) {
            ...
            strSQL.append("\",");
            Loger.debug("创建列：" + property.getColumn());
        }

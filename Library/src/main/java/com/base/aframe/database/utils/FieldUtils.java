 ...
 */
package com.base.aframe.database.utils;
...
import com.base.aframe.database.annotate.ManyToOne;
import com.base.aframe.database.annotate.OneToMany;
import com.base.aframe.database.annotate.Property;
import com.base.aframe.database.annotate.Transient;
...
public class FieldUtils {
    ...
    public static Field getFieldByColumnName(Class<?> clazz, String columnName) {
        ...
        if (columnName != null) {
            ...
            if (fields != null && fields.length > 0) {
                ...
                if (field == null) {
                    for (Field f : fields) {
                        com.base.aframe.database.annotate.Property property = f.getAnnotation(com.base.aframe.database.annotate.Property.class);
                        if (property != null
                        ...
                        com.base.aframe.database.annotate.ManyToOne manyToOne = f.getAnnotation(com.base.aframe.database.annotate.ManyToOne.class);
                        if (manyToOne != null
    ...
    public static String getColumnByField(Field field) {
        com.base.aframe.database.annotate.Property property = field.getAnnotation(com.base.aframe.database.annotate.Property.class);
        if (property != null && property.column().trim().length() != 0) {
            return property.column();
        }

        com.base.aframe.database.annotate.ManyToOne manyToOne = field.getAnnotation(com.base.aframe.database.annotate.ManyToOne.class);
        if (manyToOne != null && manyToOne.column().trim().length() != 0) {
            return manyToOne.column();
        }

        com.base.aframe.database.annotate.OneToMany oneToMany = field.getAnnotation(com.base.aframe.database.annotate.OneToMany.class);
        if (oneToMany != null && oneToMany.manyColumn() != null
                && oneToMany.manyColumn().trim().length() != 0) {
            return oneToMany.manyColumn();
        }

        com.base.aframe.database.annotate.Id id = field.getAnnotation(com.base.aframe.database.annotate.Id.class);
    ...
    public static String getPropertyDefaultValue(Field field) {
        com.base.aframe.database.annotate.Property property = field.getAnnotation(Property.class);

...
public final class CipherUtils {
    ...
    public static String md5(String string) {
        ...
        try {
            ...
            throw new WYException("Huh, MD5 should be supported?", e);
        } catch (UnsupportedEncodingException e) {
            throw new WYException("Huh, UTF-8 should be supported?", e);
        }
    ...
    public static String decrypt(String data, Key key, String algorithm)
        ...
        String result = new String(cipher.doFinal(StrUtils
    ...
    public static String encrypt(String data, Key key, String algorithm)
        ...
        return StrUtils.byteArrayToHexString(cipher.doFinal(data
                .getBytes("utf8")));
    }
}

...
public abstract class WYTaskExecutor<Params, Progress, Result> {
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                try {
                    ...
                    Loger.debugLog(getClass().getName(),
                            e.getMessage());
    ...
    private Result postResult(Result result) {
        ...
        Message message = mHandler.obtainMessage(MESSAGE_POST_RESULT,
                new WYTaskResult<Result>(this, result));
    ...
    protected final void publishProgress(Progress... values) {
        if (!isCancelled()) {
            mHandler.obtainMessage(MESSAGE_POST_PROGRESS,
                    new WYTaskResult<Progress>(this, values))
                    .sendToTarget();
        }
    }
     ...
     */
    public final WYTaskExecutor<Params, Progress, Result> execute(
            Params... params) {
     ...
     */
    public final WYTaskExecutor<Params, Progress, Result> executeOnExecutor(
    ...
    private static class InternalHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            WYTaskResult result = (WYTaskResult) msg.obj;
            switch (msg.what) {
    ...
    private static class WYTaskResult<Data> {
        final Data[] mData;
        final WYTaskExecutor<?, ?, ?> mTask;

        WYTaskResult(WYTaskExecutor<?, ?, ?> task, Data... data) {
            mTask = task;
            mData = data;
        }
    }

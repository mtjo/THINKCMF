...
public class XHeaderView extends LinearLayout {
    private LinearLayout mContainer,text_lay;
    private ImageView mArrowImageView;
    private ProgressBar mProgressBar,chatProgerssBar;
    ...
    private void initView(Context context) {
        ...
        chatProgerssBar = (ProgressBar) findViewById(R.id.header_chat_progressbar);
        text_lay = (LinearLayout)findViewById(R.id.header_text_layout);
    ...
    public void chatSet(){
    	if(null != text_lay)text_lay.setVisibility(View.GONE);
    	if(null != mArrowImageView)mArrowImageView.setVisibility(View.GONE);
    	if(null != mProgressBar)mProgressBar.setVisibility(View.GONE);
    	if(null != chatProgerssBar)chatProgerssBar.setVisibility(View.VISIBLE);
    }
}

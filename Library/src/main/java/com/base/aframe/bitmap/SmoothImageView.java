package com.base.aframe.bitmap;
...
public class SmoothImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {  
        ...
        if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {  
            ...
            if(mTransformStart){  
                Loger.debug("Dean:mTransfrom.startScale:" + mTransfrom.startScale);
                Loger.debug("Dean:mTransfrom.startScale:"+mTransfrom.endScale);  
                Loger.debug("Dean:mTransfrom.scale:"+mTransfrom.scale);  
                Loger.debug("Dean:mTransfrom.startRect:"+mTransfrom.startRect.toString());  
                Loger.debug("Dean:mTransfrom.endRect:"+mTransfrom.endRect.toString());  
                Loger.debug("Dean:mTransfrom.rect:"+mTransfrom.rect.toString());  
            }  
